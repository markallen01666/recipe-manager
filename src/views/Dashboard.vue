              ...
              <v-layout row justify-center="true" mt-4>
                ...
                <v-flex xs1>
                  <DeleteProject
                    class="modifier"
                    :project="project"
                    @deletedProject="deletedProject(index)"
                  />
                </v-flex>
              </v-layout>
            </v-card-text>
...
export default {
  components: { EditProject, DeleteProject },
  data() {
    return {
      format,
      projects: [],
  ...
  methods: {
    ...
    updatedProject(payload, index) {
      ...
      this.snackbarText = "Project successfully updated!";
    ...
    deletedProject(index) {
      // Update displayed project info
      this.snackbarText = "Project successfully deleted!";
      this.snackbar = true; // Display successful update message
      this.projects.splice(index, 1); // Use splice to remove project and force re-rendering of projects
    }
  },
  computed: {
